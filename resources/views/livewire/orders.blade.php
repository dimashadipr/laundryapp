                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $post->Order_Nama }}</td>
                            <td class="border px-4 py-2">{{ $post->Order_Kontak }}</td>
                            <td class="border px-4 py-2">{{ $post->Order_Alamat }}</td>
